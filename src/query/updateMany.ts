...
export async function updateMany(params: { collection: string, query: object, update: object, options?: object }, callback: any) {
    try {
        ...
        const result = collection.updateMany(query, update, options)
